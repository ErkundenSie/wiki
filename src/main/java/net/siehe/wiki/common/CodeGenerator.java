...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/wiki";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/wikidev?useUnicode=true&characterEncoding=UTF8&useSSL=false");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("wikidev");
        dsc.setPassword("1379");
